...
<svelte:head>
	<title>Apply for Admission - Asamkhya AI Builder Cohort</title>
	<meta name="description" content="Apply for boutique AI education. We're looking for sharp minds ready to build. Show us how you think." />
</svelte:head>
			...
			<div class="container">
				<div class="hero-content">
					<div class="hero-badge">
						<span class="badge-text">Premium Application</span>
					</div>
					<h1>Apply for Admission - Asamkhya AI Builder Cohort</h1>
					<p class="hero-subtitle">
						We're looking for sharp minds ready to build. Show us how you think.
					</p>
					<div class="hero-details">
						<div class="detail-badge">
							<span class="detail-label">Next Batch</span>
							<span class="detail-value">October 2025</span>
						</div>
						<div class="detail-badge">
							<span class="detail-label">Seats Remaining</span>
							<span class="detail-value">12 of 15</span>
						</div>
						<div class="detail-badge">
							<span class="detail-label">Investment</span>
							<span class="detail-value">₹2,00,000</span>
						</div>
					</div>
				</div>
			</div>
					...
					<form class="comprehensive-form">
						...
						{#if currentSection === 2}
							<div class="form-section" class:active={currentSection === 2}>
								...
								<div class="form-group">
									<label for="whyIntensiveFormat">Why 20 hours of intense learning vs. a 6-month online course? What draws you to this format? *</label>
									<textarea 
						...
						{#if currentSection === 6}
							<div class="form-section" class:active={currentSection === 6}>
								<div class="section-header">
									<h2>Commitment & Pace</h2>
									<p>Help us understand your commitment and vision for success.</p>
								</div>
								
								<div class="form-group">
									<label for="keepingUpPlan">This is 20 hours over a short period with very capable people. What's your plan for keeping up? *</label>
									<textarea 
										id="keepingUpPlan" 
						...
						<div class="form-navigation">
							...
							{:else}
								...
								>
									...
									{:else}
										Submit Application - We'll review and contact you within 48 hours
									{/if}
								</button>
							{/if}
						</div>
			...
			<div class="container">
				<div class="success-content">
					...
					<p class="success-message">
						Thank you for taking the time to complete our comprehensive application. We've received your responses and will review them carefully. Our founders will contact you within 48 hours to discuss your application and next steps.
					</p>
					<div class="next-steps">
						<h3>What happens next:</h3>
						<ol>
							<li>Our founders will personally review your application responses (within 24 hours)</li>
							<li>If your application shows potential, we'll schedule a detailed conversation</li>
							<li>We'll discuss your goals, our methodology, and mutual fit</li>
							<li>If accepted, we'll provide enrollment details and payment options</li>
						</ol>
					</div>
					<div class="success-actions">
						<a href="/asamkhya" class="success-button">Back to Program Details</a>
						<a href="/asamkhya/contact" class="success-button secondary">Have Questions?</a>
					</div>
				</div>
			</div>
		</section>
